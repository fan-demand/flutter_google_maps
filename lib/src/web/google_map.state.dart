...
class GoogleMapState extends GoogleMapStateBase {
  ...
  @override
  void clearMarkers() {
    for (dynamic marker in _markers.values) {
      marker?.map = null;
      marker = null;
    }
    _markers.clear();

    for (dynamic info in _infos.values) {
      info?.close();
      info = null;
    }
    _infos.clear();
  ...
  void clearDirections() {
    for (dynamic direction in _directions.values) {
      direction?.map = null;
  ...
  @override
  void clearPolygons() {
    for (dynamic polygon in _polygons.values) {
      polygon?.map = null;
      polygon = null;
    }
    _polygons.clear();
  ...
  @override
  void clearCircles() {
    for (dynamic circle in _circles.values) {
      circle?.map = null;
      circle = null;
    }
    _circles.clear();
